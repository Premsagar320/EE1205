...
\begin{axis}[
    ...
    ymax=2,
    xlabel={$t\ (\text{ms})$},
    ylabel={$V_{\text{out}}\ (\text{V})$},
    xtick={0,0.5,1,2,3,4,5,6},
    ytick={0,0.4,0.6,1},
    ]
    \addplot [black, thick, smooth] coordinates {(0,0)(0.5,0.4)(2,0.4)};    
    \addplot [black, thick] coordinates {(2,0.4)(2.5,0.4)(3,1)(6,1)};  % Modified segment
\end{axis}
\end{tikzpicture}
\end{document}

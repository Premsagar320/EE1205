...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11065 - YAGATI PREM SAGAR$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/Premsagar320/EE1205/blob/main/Audio_%20Filter/codes/PremSagar-singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{figs/Before _Audio filter.png }
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{figs/After_Audio filter.png}
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/2.2.py
\end{lstlisting}
\begin{figure}[H]
	\centering
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Premsagar320/EE1205/tree/main/Audio_%20Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
